...
- [Executed analysis notebook](notebooks/covid19_survey_classification.ipynb)
- [Reusable training script](src/train_models.py)
- [Model metrics](results/model_metrics.csv)
- [Data provenance and access](data/README.md)
...
|-- notebooks/
|   `-- covid19_survey_classification.ipynb
|-- results/
